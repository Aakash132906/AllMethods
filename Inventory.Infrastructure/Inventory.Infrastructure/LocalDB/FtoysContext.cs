...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ANS\\SQLEXPRESS;Initial Catalog=Ftoys;user id=ftoys;password=ftoys@123;Integrated Security=false;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Classifi__3214EC07261ACB00");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__ProductL__B40CC6CD815C70B0");
        ...
        {
            entity.HasKey(e => e.Fid).HasName("PK__TempProd__C1BEAA42F06DBE91");
